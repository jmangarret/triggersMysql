...
UPDATE  `vtiger_cvcolumnlist` SET `columnname` = 'vtiger_boletos:fecha_emision:fecha_emision:Boletos_FECHA_EMISION:V' WHERE `vtiger_cvcolumnlist`.`cvid` = 143 AND `vtiger_cvcolumnlist`.`columnindex` = 5; 
