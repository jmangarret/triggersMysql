...
insert into vtiger_registrodeventas(registrodeventasid,registrodeventasname,registrodeventastype,fecha,contacto) 
	values(12691,'VEN02707','Boleto',NULL,'466')

select * from vtiger_field 
	where tabid='52' and tablename='vtiger_registrodeventascf' and displaytype in (1,3,4) and vtiger_field.presence in (0,2)
