...
FOR EACH ROW BEGIN
	...
	NEW.passenger, NEW.gdsName, NEW.itemDate, NEW.pnrCreationDate, NEW.departureDate, NEW.ticketNumber, CONCAT(NEW.airlineid,'/',NEW.airlinedescription), NEW.PriceVAT, NEW.priceVAT+NEW.otherTax,
    _emittedStatus, NEW.ticketingAgentname, NEW.ticketingAgentid, NEW.bookingAgentname, NEW.bookingAgentid, NEW.marketPlace, NEW.itinerary,@find_paymentmethod);
