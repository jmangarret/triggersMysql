...
FOR EACH ROW BEGIN  
	...
	SELECT localizador,ticket_number,gds,paymentmethod,solicitud,org_rif,org_name,asesor_rif,user_ci,user_name,ticket_creado,localizador_status	
	...
	CALL vtigercrm600.valCuenta(rif,org,fech,org,@idcrm,@iduser);#Devuelve @id_cuenta
